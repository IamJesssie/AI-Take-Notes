...
Cohesion: 0.01
Nodes (91): abort(), Acrobat7, _addNamespacePrefix(), addState(), BaseException(), BatchOutput, bezierBoundingBox(), build() (+83 more)

### Community 1 - "f"
Cohesion: 0.02
Nodes (61): AppearanceFilter, Barcode, Bookend, Break, BreakAfter, BreakBefore, Calculate, Certificate (+53 more)
...
Cohesion: 0.02
Nodes (67): ar(), channel(), cloneDeep(), cloneRequestState(), constructor(), createNamespace(), createNamespaceIfNotExists(), _createOAuthClient() (+59 more)

### Community 8 - ".i"
Cohesion: 0.08
Nodes (74): _acquireLock(), _approveAuthorization(), _authenticate(), _autoRefreshTokenTick(), _callRefreshToken(), _challengeAndVerify(), _debug(), _denyAuthorization() (+66 more)
...
Cohesion: 0.06
Nodes (47): addFontStyle(), beginText(), closeEOFillStroke(), closeFillStroke(), closePath(), closeStroke(), constructPath(), _ensureClipGroup() (+39 more)

### Community 13 - "WidgetAnnotation"
Cohesion: 0.10
Nodes (6): ButtonWidgetAnnotation, ChoiceWidgetAnnotation, fetchIfRef(), getCharPositions(), TextWidgetAnnotation, WidgetAnnotation

### Community 15 - ".add"
Cohesion: 0.04
Nodes (15): AnnotationElement, CaretAnnotationElement, CircleAnnotationElement, getRectDims(), HighlightAnnotationElement, InkAnnotationElement, LineAnnotationElement, PolylineAnnotationElement (+7 more)
...
Cohesion: 0.17
Nodes (6): CFFDict, CFFPrivateDict, CFFTopDict, createDict(), emptyPrivateDictionary(), parsePrivateDict()

### Community 21 - ".createElement"
Cohesion: 0.08
Nodes (8): AnnotationStorage, CheckboxWidgetAnnotationElement, ChoiceWidgetAnnotationElement, LinkAnnotationElement, PushButtonWidgetAnnotationElement, RadioButtonWidgetAnnotationElement, TextWidgetAnnotationElement, WidgetAnnotationElement
...
### Community 32 - "log"
Cohesion: 0.09
Nodes (41): _addToPushBuffer(), _appendParams(), _clearAllTimers(), _clearTimer(), connect(), connectionState(), disconnect(), endpointURL() (+33 more)

### Community 33 - "PopupElement"
Cohesion: 0.09
Nodes (30): _cancelRefEvent(), _cancelTimeout(), _canPush(), destroy(), _fetchWithTimeout(), finally(), _getPayloadRecords(), _hasReceived() (+22 more)
...
Cohesion: 0.06
Nodes (16): composeSMask(), composeSMaskBackdrop(), CFFFDSelect, compileCharString(), CompiledFont, getSubroutineBias(), lookupCmap(), Type1CharString (+8 more)
...
### Community 50 - ".a"
Cohesion: 0.07
Nodes (18): appendText(), BaseSVGFactory, FileAttachmentAnnotationElement, FreeTextAnnotationElement, get(), getCtx(), getPathGenerator(), isDataScheme() (+10 more)
...
Cohesion: 0.06
Nodes (11): BaseFullReader, BaseRangeReader, createRequestOptions(), KeyboardManager, NetworkManager, on(), PDFNodeStreamFsFullReader, PDFNodeStreamFsRangeReader (+3 more)
...
### Community 58 - "t"
Cohesion: 0.08
Nodes (39): ce(), copy(), createBucket(), createIndex(), createSignedUploadUrl(), createSignedUrl(), createSignedUrls(), deleteBucket() (+31 more)

### Community 60 - "PDFFetchStreamReader"
Cohesion: 0.04
Nodes (16): BaseCMapReaderFactory, BaseStandardFontDataFactory, cancelAllRequests(), createFetchOptions(), createHeaders(), DOMCMapReaderFactory, DOMStandardFontDataFactory, fetchData() (+8 more)
...
Cohesion: 0.07
Nodes (14): applyAssist(), Br, Button, ContentArea, getBorderDims(), handleBreak(), handleOverflow(), Html (+6 more)
...
### Community 74 - "bind"
Cohesion: 0.11
Nodes (10): Dict, documentInfo(), load(), loadXfaFonts(), loadXfaImages(), writeArray(), writeDict(), writeObject() (+2 more)
...
### Community 82 - ".reset"
Cohesion: 0.18
Nodes (3): InclusionTree, parseTilePackets(), TimeSlotManager
...
Cohesion: 0.05
Nodes (40): ComponentPositionResolutionLayerIterator(), ConnectionSet, createPacket(), EffectiveInputPolicy, EffectiveOutputPolicy, getPrecinctIndexIfExist(), getPrecinctSizesInImageScale(), LayerResolutionComponentPositionIterator() (+32 more)
...
### Community 124 - "rr"
Cohesion: 0.09
Nodes (32): _addPixels(), _addPixelsNeg(), amend(), amendFallbackToUnicode(), applyStandardFontGlyphMap(), buildAddOperation(), buildMinOperation(), buildMulOperation() (+24 more)
